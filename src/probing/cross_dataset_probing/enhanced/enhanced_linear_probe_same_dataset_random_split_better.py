...
def main():
    ...
    activation_train, activation_test, target_train, target_test = train_test_split(
        all_activations_layer, all_targets, test_size=0.5, random_state=42
    )
    ...
    print("=" * 50)
    print("Probe trained on 50% of test split activations")
    print("Probe tested on remaining 50% of test split activations")
