...
def create_simple_dataset(num_samples: int = 4000, noise_std: float = 0.0, seed: int = 0) -> Tuple[
...
def apply_activation_patching(regressor: TabPFNRegressor, model, X_np: np.ndarray,
							  patch_dict: Dict[str, torch.Tensor]) -> np.ndarray:
