#!/usr/bin/env python3
"""Option A: steer full 192-d features MHA output at Layer 0."""
...
def main() -> None:
    ...
    fig_path = Path("docs/attention_head_patching/steering_full_mha_output.png")
    plot_results(
        results,
        "Steering A: Full 192-d Features MHA Output at Layer 0",
        fig_path,
        baseline_mse,
    )
    ...
    config = {
        ...
        "hook": "layer_0.self_attn_between_features._compute",
        "n_eval": int(N_EVAL),
        "layer_idx": LAYER_IDX,
    ...
    print_results_summary("A", results)
